	...
	extends ExercisesFragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		Button addExercisesToRoutineButton = mView.findViewById(R.id.btn_addExercisesToRoutine);
		...
		Button clearSelectionButton = mView.findViewById(R.id.btn_routine_exercises_overview_clear);
